...
import { defaultResponse, IResponse } from '@shared/interceptors/response.interceptor';
...
export class Exception<TData> extends BaseException<TData> {
  constructor(payload: IResponse<TData>, statusCode: number = HttpStatus.INTERNAL_SERVER_ERROR) {
    super(payload, statusCode);
  }
}
