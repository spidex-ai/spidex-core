...
export class TaptoolsService {
  ...
  async getTokenPriceChanges(unit: string, timeframes: string[]): Promise<TokenPriceChange> {
    try {
      const response = await firstValueFrom(
        this.client.get<TokenPriceChange>('token/prices/chg', { params: { unit, timeframes: timeframes.join(',') } }),
      );
  ...
  async getTopTokenHolders(unit: string, page = 1, perPage = 10): Promise<TokenHolder[]> {
    try {
      const response = await firstValueFrom(
        this.client.get<TokenHolder[]>('token/holders/top', { params: { unit, page, perPage } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getTokenPools(unit: string, isAdaOnly = false): Promise<TokenPool[]> {
    try {
      const response = await firstValueFrom(
        this.client.get<TokenPool[]>('token/pools', { params: { unit, adaOnly: isAdaOnly ? 1 : 0 } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getTokenOHLCV(unit: string, interval: string, numIntervals?: number, quote = 'USD'): Promise<TokenOHLCV[]> {
    try {
      const response = await firstValueFrom(
        this.client.get<TokenOHLCV[]>('token/ohlcv', { params: { unit, interval, numIntervals, quote } }),
      );
      return response.data;
    } catch (error) {
    ...
    try {
      const response = await firstValueFrom(
        this.client.get<TokenTrade[]>('token/trades', {
          params: { unit, timeframe, page, perPage, sortBy: 'time', order: 'desc' },
        }),
      );
      return response.data;
    } catch (error) {
  ...
  async getTokenTradingStats(unit: string, timeframe = '24h'): Promise<TokenTradingStats> {
    try {
      const response = await firstValueFrom(
        this.client.get<TokenTradingStats>('token/trading/stats', { params: { unit, timeframe } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getTopTokensByVolume(timeframe = '24h', page = 1, perPage = 10): Promise<TopToken[]> {
    try {
      const response = await firstValueFrom(
        this.client.get<TopToken[]>('token/top/volume', { params: { timeframe, page, perPage } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getTopTokensByMcap(page = 1, perPage = 10): Promise<TopTokenMcap[]> {
    try {
      const response = await firstValueFrom(
        this.client.get<TopTokenMcap[]>('token/top/mcap', { params: { type: 'mcap', page, perPage } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getTopTokensByLiquidity(page = 1, perPage = 10): Promise<TopTokenLiquidity[]> {
    try {
      const response = await firstValueFrom(
        this.client.get<TopTokenLiquidity[]>('token/top/liquidity', { params: { page, perPage } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTCollectionInfo(policy: string): Promise<NFTCollectionInfo> {
    try {
      const response = await firstValueFrom(
        this.client.get<NFTCollectionInfo>('nft/collection/info', { params: { policy } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTCollectionStats(policy: string): Promise<NFTCollectionStats> {
    try {
      const response = await firstValueFrom(
        this.client.get<NFTCollectionStats>('nft/collection/stats', { params: { policy } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTCollectionStatsExtended(policy: string, timeframe = '24h'): Promise<NFTCollectionStatsExtended> {
    try {
      const response = await firstValueFrom(
        this.client.get<NFTCollectionStatsExtended>('nft/collection/stats/extended', { params: { policy, timeframe } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTAssetStats(policy: string, name: string): Promise<NFTAssetStats> {
    try {
      const response = await firstValueFrom(
        this.client.get<NFTAssetStats>('nft/asset/stats', { params: { policy, name } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTAssetTraits(policy: string, name: string, prices = 1): Promise<NFTAssetTraits> {
    try {
      const response = await firstValueFrom(
        this.client.get<NFTAssetTraits>('nft/asset/traits', { params: { policy, name, prices } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTCollectionTradesStats(policy: string, timeframe = '24h'): Promise<NFTCollectionTradesStats> {
    try {
      const response = await firstValueFrom(
        this.client.get<NFTCollectionTradesStats>('nft/collection/trades/stats', { params: { policy, timeframe } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTCollectionListings(policy: string): Promise<NFTCollectionListings> {
    try {
      const response = await firstValueFrom(
        this.client.get<NFTCollectionListings>('nft/collection/listings', { params: { policy } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTCollectionOHLCV(
    ...
    try {
      const response = await firstValueFrom(
        this.client.get<NFTCollectionOHLCV[]>('nft/collection/ohlcv', {
          params: { policy, interval, numIntervals, quote },
        }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTCollectionTrades(
    ...
    try {
      const response = await firstValueFrom(
        this.client.get<NFTCollectionTrade[]>('nft/collection/trades', {
          params: { policy, timeframe, page, perPage },
        }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTMarketStats(timeframe = '24h'): Promise<NFTMarketStats> {
    try {
      const response = await firstValueFrom(
        this.client.get<NFTMarketStats>('nft/market/stats', { params: { timeframe } }),
      );
      return response.data;
    } catch (error) {
  ...
  async getNFTCollectionHoldersDistribution(policy: string): Promise<NFTCollectionHoldersDistribution> {
    try {
      const response = await firstValueFrom(
        this.client.get<NFTCollectionHoldersDistribution>('nft/collection/holders/distribution', {
          params: { policy },
        }),
      );
      return response.data;
   ...
   */
  async getNFTCollectionTrendedHolders(policy: string, timeframe = '30d'): Promise<NFTCollectionHolderTrended[]> {
    try {
      const response = await firstValueFrom(
   ...
   */
  async getNFTCollectionListingsDepth(policy: string, items = 500): Promise<NFTCollectionListingDepth[]> {
    try {
      const response = await firstValueFrom(
   ...
   */
  async getNFTMarketplaceStats(timeframe = '7d', marketplace?: string, lastDay = 0): Promise<NFTMarketplaceStats[]> {
    try {
      const response = await firstValueFrom(
   ...
   * @param perPage - Items per page
   */
  async getNFTTopVolume(timeframe = '24h', page = 1, perPage = 10): Promise<NFTTopVolume[]> {
    try {
      const response = await firstValueFrom(
   ...
   * @param perPage - Items per page
   */
  async getNFTTopVolumeExtended(timeframe = '24h', page = 1, perPage = 10): Promise<NFTTopVolumeExtended[]> {
    try {
      const response = await firstValueFrom(
   ...
   * @param perPage - Items per page
   */
  async getWalletTokenTrades(address: string, unit?: string, page = 1, perPage = 100): Promise<WalletTradeToken[]> {
    try {
      const response = await firstValueFrom(
   ...
   * @param quote - Quote currency
   */
  async getWalletValueTrended(address: string, timeframe = '30d', quote = 'ADA'): Promise<WalletValueTrended[]> {
    try {
      const response = await firstValueFrom(
  ...
  async getAssetSupply(unit: string): Promise<{ supply: number }> {
    try {
      const response = await firstValueFrom(this.client.get<{ supply: number }>('assets/supply', { params: { unit } }));
      return response.data;
    } catch (error) {
   ...
   */
  async getAddressInfo({ address, paymentCred }: { address?: string; paymentCred?: string }): Promise<AddressInfo> {
    try {
      const response = await firstValueFrom(
